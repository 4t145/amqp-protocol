...
impl<W: io::Write> Encode<W> for Descriptor {
    fn encode(&self, writer: &mut W) -> io::Result<()> {
        match self {
...
impl<W: io::Write> Encode<W> for Constructor {
    fn encode(&self, writer: &mut W) -> io::Result<()> {
        match self {
...
impl<W: io::Write> Encode<W> for Value {
    fn encode(&self, writer: &mut W) -> io::Result<()> {
        todo!()
    }
}
...
impl<W: io::Write> Encode<W> for Primitive {
    fn encode(&self, writer: &mut W) -> io::Result<()> {
        match self {
